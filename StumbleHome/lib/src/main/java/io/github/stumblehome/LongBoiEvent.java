...
public class LongBoiEvent extends Sprite {
  ...
  /**
   * This function is not very good. It controls the walking of long boi, each 'if' statement is the
   * different distances long boi walks in the x and y directions in order. Needs to only execute
   * once per frame hence why it is if statements, otherwise it will just teleport.
   */
