...
public class KeycardEvent extends Sprite {
    ...
    /**
     * Extracts animation frames from the keycard spritesheet. Sets up a 3-frame looping animation.
     */
    ...
    /**
     * Checks whether the player has collided with the keycard using pythagoras theorem between the
     * centres of the keycard and player.
     *
