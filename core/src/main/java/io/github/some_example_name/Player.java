...
public class Player extends Sprite {
    ...
    // Possible animation processes the player can be in.
    private enum Animation_enum { DOWN, LEFT, RIGHT, UP, WALK_DOWN, WALK_LEFT, WALK_RIGHT, WALK_UP }
    ...
    public Player(Sprite sprite, float mapWidth, float mapHeight, TiledMapTileLayer collisionLayer) {
        ...
        SwapControls(); // intialises as normal for understandability and then gets player drunk
    ...
    private void initializeAnimations() {
        ...
        animations.put(Animation_enum.RIGHT, new Animation<TextureRegion>(0.1f, stand_frames.clone()));

        stand_frames[0] = new TextureRegion(characterSheet, 198, 9, FRAME_WIDTH, FRAME_HEIGHT);
        animations.put(Animation_enum.LEFT, new Animation<TextureRegion>(0.1f, stand_frames.clone()));
        ...
        animations.put(Animation_enum.DOWN, new Animation<TextureRegion>(0.1f, stand_frames.clone()));
